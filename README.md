...
How It Works
You open or edit a folder on your Desktop.

Windows updates that folder’s “last modified” time.

The watcher checks all Desktop folders.

It finds the folder with the newest modified time.

It sends that folder name to your backend.

Your backend updates your Slack status.

Installation
Place watcher.js and package.json in a folder.
...
# ⭐ Step‑by‑Step Setup (also Markdown, also safe to copy)
